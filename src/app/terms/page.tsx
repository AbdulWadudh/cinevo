...
export const metadata = {
  title: "Terms of Service — Cinevo",
  description: "The terms that govern your use of Cinevo.",
};
      ...
      <main className="pt-24 md:pt-28 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col gap-8 text-sm md:text-base text-fg-secondary leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using Cinevo, you agree to these Terms of Service. If you do not agree, please do
              not use the service. Cinevo is a personal, non-commercial project provided &quot;as is&quot;.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You agree to use Cinevo only for lawful, personal purposes. You are responsible for any activity
          ...
          <section>
            ...
            <p>
              Movie and TV metadata and images are provided by The Movie Database (TMDB). Cinevo does not host,
          ...
          <section>
            ...
            <p>
              ...
              Cinevo is not liable for any damages arising from your use of the service or any third-party content
              accessed through it.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may update these terms from time to time. Continued use of Cinevo after changes constitutes
          ...
          <section>
            ...
            <p>Questions about these terms? Reach us at <span className="text-accent">support@cinevo.app</span>.</p>
          </section>
        </div>
      </main>
    </div>
