...
export default function DomeGallery({
  ...
  // Keep the latest callbacks in refs so the imperative open/close handlers
  // don't need to re-subscribe when the parent re-renders.
  const onOpenItemRef = useRef(onOpenItem);
  onOpenItemRef.current = onOpenItem;
  const onCloseItemRef = useRef(onCloseItem);
  onCloseItemRef.current = onCloseItem;
  ...
  // Continuous idle auto-rotation. Pauses while dragging, coasting (inertia),
  // or when an image is enlarged. Disabled under prefers-reduced-motion.
  useEffect(() => {
